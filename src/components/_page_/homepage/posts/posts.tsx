...
const Posts: React.FC<Props> = ({item}) => {
  return (
    <div className='w-full bg-white_gray-100 dark:bg-black_gray-500 shadow-md py-2 px-4 flex flex-col md:flex-row   items-center gap-5'>
      ...
      <div className='flex flex-col gap-2'>
        <Link href={`read-post/${item.id}`}><h1 className='text-2xl font-bold'>{item.title}</h1></Link>
